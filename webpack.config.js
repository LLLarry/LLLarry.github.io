...
module.exports = {
  entry: path.join(__dirname, './js/main.js'), // 入口文件
  output: { // 指定输出选项
  ...
  plugins: [ // 所有webpack  插件的配置节点
    new htmlWebpackPlugin({
      template: path.join(__dirname, './view/index.html'), // 指定模板文件路径
  ...
  //         { from: /^\/subpage/, to: '/view/index.html' },
  //         // shows views/404.html on all other pages
  //         { from: /tt/, to: '/view/index.html' },
  //     ],
  //  }
  },
